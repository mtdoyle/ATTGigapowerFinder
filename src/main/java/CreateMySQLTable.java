...
public class CreateMySQLTable {
    ...
    public void createNewBadAddressesTable(String currDate){
        ...
        String sql = String.format("create table if not exists %3$s_%4$s_%1$s" +
                "(original_address varchar(200) %2$s, resolved_address varchar(200) %2$s)",
            currDate,
            charset,
    ...
    public void createCenturyLinkResolvedAddressTable(){
        ...
        String sql = String.format("create table if not exists resolved_addresses" +
                "(original_address varchar(200) %1$s, resolved_address varchar(200) %1$s)",
            charset);
